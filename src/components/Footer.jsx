...
const Footer = () => {
  ...
  return (
    <>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-6 gap-3 gap-y-8 md:gap-8 py-10 max-w-sm mx-auto sm:max-w-3xl lg:max-w-full">
            <div className="col-span-full mb-10 lg:col-span-2 lg:mb-0">
              ...
              <button
                onClick={openDialog} // Open the dialog when clicked
            ...
            <div className="lg:mx-auto text-left ">
              ...
              <p className="text-sm text-gray-500 leading-6 mb-7">
                I write code. A coffee would really help fuel these free
                websites! ☕
              </p>
              <a
                href="https://buymeacoffee.com/shubhadipbhowmik"
                target="_blank"
              >
                <img
            ...
            <div className="flex items-center justify-between flex-col lg:justify-between lg:flex-row">
              <div>
                <span className="text-sm text-gray-500 ">
                  ©<a href="https://omnitools.vercel.app/">OmniTools</a> 2024,
                  All rights reserved.
                </span>
              </div>
      ...
      <MyDialog isOpen={isDialogOpen} closeDialog={closeDialog} />
    </>
  );
};
